...
var file_hexzpb_hexz_proto_rawDesc = []byte{
	...
	0x46, 0x61, 0x73, 0x74, 0x4d, 0x6f, 0x76, 0x65, 0x22, 0xaf, 0x01, 0x0a, 0x1a, 0x41, 0x64, 0x64,
	...
	0x72, 0x6b, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xb3, 0x02, 0x0a, 0x1b, 0x41,
	...
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x32, 0xfd, 0x01, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x69, 0x6e, 0x69,
	...
	0x74, 0x22, 0x00, 0x30, 0x01, 0x32, 0x5c, 0x0a, 0x10, 0x43, 0x50, 0x55, 0x50, 0x6c, 0x61, 0x79,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x48, 0x0a, 0x0b, 0x53, 0x75, 0x67,
...
var file_hexzpb_hexz_proto_depIdxs = []int32{
	...
	21, // 26: hexzpb.AddTrainingExamplesResponse.latest_model:type_name -> hexzpb.ModelKey
	16, // 27: hexzpb.TrainingExample.move:type_name -> hexzpb.GameEngineMove
	4,  // 28: hexzpb.TrainingExample.encoding:type_name -> hexzpb.TrainingExample.Encoding
	34, // 29: hexzpb.TrainingExample.model_predictions:type_name -> hexzpb.TrainingExample.ModelPredictions
	21, // 30: hexzpb.TrainingExample.model_key:type_name -> hexzpb.ModelKey
	35, // 31: hexzpb.TrainingExample.stats:type_name -> hexzpb.TrainingExample.Stats
	21, // 32: hexzpb.FetchModelRequest.model_key:type_name -> hexzpb.ModelKey
	5,  // 33: hexzpb.FetchModelRequest.encoding:type_name -> hexzpb.ModelEncoding.Enum
	21, // 34: hexzpb.FetchModelResponse.model_key:type_name -> hexzpb.ModelKey
	5,  // 35: hexzpb.FetchModelResponse.encoding:type_name -> hexzpb.ModelEncoding.Enum
	36, // 36: hexzpb.ControlEvent.training_started:type_name -> hexzpb.ControlEvent.TrainingStarted
	37, // 37: hexzpb.ControlEvent.training_done:type_name -> hexzpb.ControlEvent.TrainingDone
	16, // 38: hexzpb.MCTSExample.MoveStats.move:type_name -> hexzpb.GameEngineMove
	2,  // 39: hexzpb.SuggestMoveStats.Score.kind:type_name -> hexzpb.SuggestMoveStats.ScoreKind
	1,  // 40: hexzpb.SuggestMoveStats.ScoredMove.type:type_name -> hexzpb.Field.CellType
	32, // 41: hexzpb.SuggestMoveStats.ScoredMove.scores:type_name -> hexzpb.SuggestMoveStats.Score
	23, // 42: hexzpb.TrainingService.AddTrainingExamples:input_type -> hexzpb.AddTrainingExamplesRequest
	27, // 43: hexzpb.TrainingService.FetchModel:input_type -> hexzpb.FetchModelRequest
	29, // 44: hexzpb.TrainingService.ControlEvents:input_type -> hexzpb.ControlRequest
	18, // 45: hexzpb.CPUPlayerService.SuggestMove:input_type -> hexzpb.SuggestMoveRequest
	24, // 46: hexzpb.TrainingService.AddTrainingExamples:output_type -> hexzpb.AddTrainingExamplesResponse
	28, // 47: hexzpb.TrainingService.FetchModel:output_type -> hexzpb.FetchModelResponse
	30, // 48: hexzpb.TrainingService.ControlEvents:output_type -> hexzpb.ControlEvent
	20, // 49: hexzpb.CPUPlayerService.SuggestMove:output_type -> hexzpb.SuggestMoveResponse
